    ...
    return (
        <nav className="navCalendar">
            <div className="nav-buttons">
                ...
                <NavLink to="/panel-carga" className={({ isActive }) =>
                    isActive ? "nav-button active" : "nav-button"
                }
                >
                ...
                <NavLink to="/vista-estudiantes" className={({ isActive }) =>
                    isActive ? "nav-button active" : "nav-button"
                }
                >
                ...
                <NavLink to="/panel-evaluacion" className={({ isActive }) =>
                    isActive ? "nav-button active" : "nav-button"
                }
                >
                    <img src={panelEvaluacionImg} alt="Panel Evaluación" />
                    Panel de Evaluación
                </NavLink>
                <NavLink to="/cerrar-sesion" className="nav-button">
